...
{
    public partial class FrameLoginIUser : Form
    {

       public FrameLoginIUser()
        {
        ...
        private void txtBoxIUser_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void txtBoxClave_KeyPress(object sender, KeyPressEventArgs e)
        {
            if ((Keys)e.KeyChar == Keys.Enter)
            {
                if (!String.IsNullOrWhiteSpace(txtBoxIUser.Text))
                {
        ...
        private void FrameLoginIUser_FormClosing(object sender, FormClosingEventArgs e)
        {
