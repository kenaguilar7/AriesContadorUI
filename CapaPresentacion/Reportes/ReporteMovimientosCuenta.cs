...
{
    public partial class ReporteMovimientosCuenta : Form
        /*, ICallingForm*/
    {
        ...
        //                        (DataTable)GridDatos.DataSource, GlobalConfig.company, GlobalConfig.UserDTO, (Cuenta)txtBoxCuentaSeleccionada.Tag);
        ...
        //        else
        //        {
        //            MessageBox.Show("Seleccione una cuenta", StaticInfoString.NombreApp, MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
        //        }
        //    }
        //    catch (Exception ex)
        //    {
