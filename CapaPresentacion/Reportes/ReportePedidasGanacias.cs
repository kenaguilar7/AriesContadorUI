...
namespace CapaPresentacion.Reportes
{
    public partial class ReportePedidasGanacias : Form
    {
        ...
        //{
        //    var lst = await CuentaCL.GetAllAsync(GlobalConfig.company.Codigo);
        ...
        //{
        //    var lstFechas = await FechaTransaccionCL.GetAllAsync(GlobalConfig.company.Codigo);
        ...
        //    try
        //    {
        //        _lstExcel = await CuentaCL.GetAllAccountBalanceWithJournalEntriesRangeAsync(GlobalConfig.company.Codigo, _StartPostingPeriod.Id, _EndPostingPeriod.Id);
        //        CargarFormulario();
        //    }
        //    catch (Exception ex)
        //    {
        ...
        //                //ReportePerdidasGanancias.GenerarReporte(sfd.FileName, _lstExcel.ToList(), GlobalConfig.Compañia, GlobalConfig.UserDTO);
        //            }
        //        }
        //    }
        //    catch (Exception ex)
