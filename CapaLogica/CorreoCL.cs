...
namespace CapaLogica
{
    public class CorreoCL
    {
        ...
        //    return rejecteds;
        //}
        //public Boolean Push(IUserTemporal UserDTO)
        //{
        //    try
        //    {
        ...
        //        mail.To.Add(new MailAddress(UserDTO.CorreoElectronico));
        //        mail.CC.Add(new MailAddress(UserDTO.CCopy));
        //        mail.Subject = UserDTO.Asunto;
        //        mail.IsBodyHtml = true;
        //        mail.Body = $"<html><nav><h1>{UserDTO.Titulo}</h1><span>{UserDTO.Cuerpo}</span><h6></h6></nav></html>";
        //        client.Send(mail);
