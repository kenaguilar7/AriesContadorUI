...
namespace CapaEntidad.Entidades.Cuentas
{
    ...
    public class Cuenta
    {
        ...
        //[JsonIgnore]
        //[JsonProperty(ItemConverterType = typeof(CustomConverter<ITipoCuenta>))]
        ...
        [JsonConstructor]
        public Cuenta(string nombre, Compañia myCompania, int id, int padre, decimal saldoAnteriorColones, decimal saldoAnteriorDolares, decimal debitosColones, decimal debitosDolares, decimal creditosColones, decimal creditosDolares, string detalle, bool active, IndicadorCuenta indicador, ITipoCuenta tipoCuenta, bool editable, string pathDirection, bool cuadrada)
        {
            Nombre = nombre;
            ...
            DebitosColones = debitosColones;
            DebitosDolares = debitosDolares;
            CreditosColones = creditosColones;
            CreditosDolares = creditosDolares;
            Detalle = detalle;
            Active = active;
            Indicador = indicador;
        ...
        public bool Validate(IValidator<Cuenta> validator, ref IEnumerable<string> brokenRules)
            => validator.IsValid(this, ref brokenRules); 
    }
}